...
import { FiCamera, FiHome, FiMail, FiMessageSquare, FiUser } from 'react-icons/fi';

export default function NavBarre() {
    return (
        <nav className="max-w-9xl fixed top-4 left-1/2 z-50 mt-6 w-[95%] -translate-x-1/2 rounded-full border border-cyan-400/40 bg-black/50 px-8 py-3 shadow-lg backdrop-blur-md">
            <div className="flex items-center justify-between">
                <Link href="/" className="flex flex-shrink-0 items-center">
                    <div className="h-18 w-18 overflow-hidden rounded-lg ml-3">
                        <img src="/images/logo6.png" alt="Logo" className="h-full w-full object-cover" />
                    </div>
                </Link>
