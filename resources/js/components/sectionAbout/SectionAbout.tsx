...
//     return (
//         <div className="flex h-screen items-center bg-gray-50" id="about">
//             {abouts.map((item) => (
//                 <section key={item.id} className="relative w-full bg-cover bg-center py-32" style={{ backgroundImage: `url('${item.image}')` }}>
...
//                                 <img src={item.image} alt={item.titre} className="h-64 w-full rounded-xl object-cover shadow-xl" />
//                             </div>
...
//                                     {item.titre}
//                                 </h2>
//                                 <p className="mb-8 text-xl" style={{ fontFamily: "'Merriweather', serif", fontStyle: 'normal', fontWeight: 100 }}>
//                                     {item.texte}
//                                 </p>
//                             </div>
//                         </div>
