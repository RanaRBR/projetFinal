        ...
        <>
            ...
            <div id="media" className="mt-40 flex min-h-screen justify-center bg-white px-6 py-12">
                <div className="w-full max-w-3xl border-t-2 border-orange-400 pt-8" style={{ fontFamily: "'Merriweather', serif" }}>
                    <h1 className="mb-10 text-3xl font-extrabold text-cyan-400 uppercase tracking-wide leading-tight">
                        {article.titre}
                    </h1>
                    ...
                    <div className="text-lg leading-relaxed text-gray-800" style={{ fontWeight: 400, lineHeight: 1.7 }}>
                        <img
                            src={article.photo}
                            alt={article.titre}
                            className="float-left mr-6 mb-10 w-[420px] max-w-full rounded-sm object-cover shadow-md"
                    ...
                    <button
                        ...
                        onClick={toggle}
                        disabled={loading}
                        className={`mt-6 flex cursor-pointer items-center gap-2 rounded-full px-4 py-2 ${
